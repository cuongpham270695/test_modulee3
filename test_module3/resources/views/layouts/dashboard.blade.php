                    ...
                    <ul class="nav-right">
                        <li class="header-notification">
                            ...
                            <ul class="show-notification">
                                ...
                                <li class="waves-effect waves-light">
                                    <div class="media">
                                        <img class="d-flex align-self-center img-radius" src="{{asset('backend/assets/images/avatar-3.jpg')}}" alt="Generic placeholder image">
                                        <div class="media-body">
                ...
                <nav class="pcoded-navbar">
                    ...
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            <li class="active">
                                <a href="home.blade.php" class="waves-effect waves-dark">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li>
                                <a href="../fruits/list.blade.php" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Fruit List</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                                ...
                                <div class="col-md-4">
                                    <ul class="breadcrumb-title">
                                        <li class="breadcrumb-item">
                                            <a href="home.blade.php"> <i class="fa fa-home"></i> </a>
                                        </li>
